...
for (i in 1:n_splits) {
  ...
  # 7. Convert risk score to class prediction using median threshold
  rsf_threshold <- median(rsf_risk)
...
for (i in 1:n_splits) {
  ...
  # 10. Convert risk score to class prediction using median threshold
  rsf_smote_threshold <- median(rsf_smote_risk)
